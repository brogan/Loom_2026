...
class SpriteTab(QWidget):
    ...
    def _setup_ui(self):
        ...
        self.translation_range_x_min_spin.setRange(-999.0, 999.0)
        ...
        self.translation_range_x_max_spin.setRange(-999.0, 999.0)
        ...
        self.translation_range_y_min_spin.setRange(-999.0, 999.0)
        ...
        self.translation_range_y_max_spin.setRange(-999.0, 999.0)
