   ...
   */
   override def keyPressed(e: KeyEvent): Unit = {
      ...
      keyCode match {
         ...
         case KeyEvent.VK_2 => interactionManager.switchRenderingMode(Renderer.STROKED)
         ...
         case KeyEvent.VK_S => interactionManager.captureStill()
         case KeyEvent.VK_V => interactionManager.captureVideo()
         case KeyEvent.VK_P => interactionManager.togglePause()
         case KeyEvent.VK_Q => interactionManager.quit()
         case KeyEvent.VK_F5 => interactionManager.reload()
