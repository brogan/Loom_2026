...
file://<WORKSPACE>/src/main/scala/org/loom/scaffold/Main.scala
...
action parameters:
uri: file://<WORKSPACE>/src/main/scala/org/loom/scaffold/Main.scala
text:
```scala
/**
Program entry point
...
object Main {
    def main(args: Array[String]): Unit  = {
        println("Scala runtime version: " + util.Properties.versionString)
