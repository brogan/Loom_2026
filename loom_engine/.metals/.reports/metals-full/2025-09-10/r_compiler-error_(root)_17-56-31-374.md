...
file://<WORKSPACE>/src/main/scala/org/loom/utility/Output.scala
...
action parameters:
uri: file://<WORKSPACE>/src/main/scala/org/loom/utility/Output.scala
text:
```scala
